        ...
        <div className="registration">
            ...
            <div className="icons-wrapper">
                <a className="reg__link google-link" href="#">
                    <img src="/public/images/icons/google.svg" alt="Google" />
                </a>
                <a className="reg__link google-plus-link" href="#">
                    <img src="/public/images/icons/github.svg" alt="Github" />
                </a>
                <a className="reg__link yandex-link" href="#">
                    <img src="/public/images/icons/yandex.svg" alt="Yandex" />
                </a>
                <a className="reg__link mail-ru-link" href="#">
                    <img src="/public/images/icons/mail.svg" alt="Mail.ru" />
                </a>
            </div>
        </div>
    )
